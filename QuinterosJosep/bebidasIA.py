...
base_de_conocimiento = [
    {
        "si": {"hora_del_dia": "manana", "preferencia_cafeina": "si", "le_gusta_dulce": True},
        "entonces": "Te recomendamos un Mocha."
    },
    {
        "si": {"hora_del_dia": "manana", "preferencia_cafeina": "si", "le_gusta_dulce": False},
        "entonces": "Te recomendamos un Americano."
    },
    {
        "si": {"hora_del_dia": "manana", "preferencia_cafeina": "no"},
...
def motor_de_inferencia(hechos, reglas):
    ...
    for regla in reglas:
        ...
        for condicion, valor in condiciones.items():
            ...
            # la regla, esta regla no se aplica.
