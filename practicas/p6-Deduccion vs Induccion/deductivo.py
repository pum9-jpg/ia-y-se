# Reutilizamos la estructura de nuestro SistemaExperto de la Unidad 2
...
print(f"Conclusión final: El animal es un {' , '.join([c for c in conclusion_final if c.startswith('es_')])}")
