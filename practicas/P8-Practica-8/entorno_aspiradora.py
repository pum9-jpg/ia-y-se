# Paso 1: Definir el Entorno de Tareas
...
class EntornoAspiradora:
    ...
    def obtener_percepcion(self):
        """
        Retorna la percepción del agente: (ubicación, estado_de_la_ubicacion).
    ...
    def ejecutar_accion(self, accion):
        ...
        if accion == 'aspirar':
            ...
            # No hace nada, no cambia el rendimiento
            pass
    ...
    def simular(self, agente, max_pasos=10):
        ...
        while not self.esta_limpio() and self.pasos < max_pasos:
            ...
            print(f"Paso {self.pasos+1}: Percepcion {percepcion_actual}, Acción={accion_elegida}")
