# Parte 1: Razonamiento Deductivo – Aplicando Reglas Generales
...
# Encontrar la conclusión final que empieza con 'es_'
conclusiones_finales = [c for c in conclusion_final if c.startswith('es_')]
if conclusiones_finales:
    print(f"Conclusión final: El animal es un '{conclusiones_finales[-1]}'")