...
# Ejemplo de uso
# Este tipo de representación facilita la consulta de información
# sobre los objetos.
...
problema_encontrado, detalles_problema = \
    buscar_problema_por_sintoma(hechos_usuario, base_conocimiento_frames)
...
# Resultado de la ejecución con hechos_usuario = ["chasquido_al_pedalear", "cadena_salta"]:
# - Usando Marcos (Frames) -
