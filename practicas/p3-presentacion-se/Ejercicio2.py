...
base_de_conocimiento = [
    ...
    {    
        ...
        "entonces": "Advertencia: La cafeina por la noche puede afectar el sueño. Te recomendamos un Espresso."    
    }    
]
...
def motor_de_inferencia(hechos, reglas):    
    ...
    for regla in reglas:    
        ...
        for condicion, valor in condiciones.items():    
            # Si un hecho del usuario no coincide con la condición de la regla,    
