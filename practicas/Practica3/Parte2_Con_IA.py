...
def motor_de_inferencia(hechos, reglas):
    ...
    for regla in reglas:
        ...
        for condicion, valor in condiciones.items():
            # Si un hecho del usuario no coincide con la condición de la regla, esta regla no se aplica.
...
print(recomendacion_ia)


# - Ventaja -
# Podemos añadir nuevas reglas sin tocar la lógica del motor.
base_de_conocimiento.append({
    "si": {"hora_del_dia": "tarde", "preferencia_cafeina": "si", "le_gusta_dulce": False},
