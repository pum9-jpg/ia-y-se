...
mapa_bolivia_mejorado = {
    ...
    'Oruro': {'La Paz': 230, 'Cochabamba': 210, 'Potosi': 320},
...
if expandidos_a_estrella < expandidos_ucs:
    print(f"A* fue más eficiente: expandio {expandidos_ucs - expandidos_a_estrella} nodos menos que UCS para encontrar la misma ruta optima.")
else:
