class SistemasExpertoDeductivo:
...
sistema_deductivo = SistemasExpertoDeductivo(reglas_animales)
...
print(f"Conclusion final: El animal es un '{next(c for c in conclusion_final if c.startswith('es_'))}'")
